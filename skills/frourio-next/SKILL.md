---
name: frourio-next
description: Skills for building type-safe Next.js API routes with frourio-next. Covers project setup, adding endpoints, middleware, and client usage with SWR/TanStack Query.
